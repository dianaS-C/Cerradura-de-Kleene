...
int main() {
    ...
    while (totalGeneradas < numDeCombinaciones) {
        if (totalGeneradas == 0) {
            // Si es la primera combinación, imprimir un espacio vacío
            printf("\n"); // No se genera ninguna combinación, solo se imprime un espacio en blanco
            totalGeneradas++; // Contamos esta primera "combinación vacía" como generada
        } else {
            // Generar longitud aleatoria entre 1 y 10
